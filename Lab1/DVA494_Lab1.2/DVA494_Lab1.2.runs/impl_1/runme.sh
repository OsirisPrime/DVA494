...
HD_PWD='C:/Users/kimsv/OneDrive - Mlardalens universitet/Workspace/VivsdoProjects/DVA494_Lab1.2/DVA494_Lab1.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_Mux2To1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_Mux2To1.tcl -notrace
