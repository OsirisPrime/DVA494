...
HD_PWD='C:/Users/kimsv/OneDrive - Mlardalens universitet/Workspace/VivsdoProjects/DVA494_Lab1.5/DVA494_Lab1.5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_double_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_double_mux.tcl
